...
void i2c_init(i2c_t devnum)
{
    ...
    /* configure pins */
    IOC->CFG[I2C_SDA_PIN] = (IOCFG_PORTID_I2C_MSSDA | IOCFG_INPUT_ENABLE | IOCFG_IOMODE_OPEN_DRAIN | IOCFG_PULLCTL_UP);
    IOC->CFG[I2C_SCL_PIN] = (IOCFG_PORTID_I2C_MSSCL | IOCFG_INPUT_ENABLE | IOCFG_IOMODE_OPEN_DRAIN | IOCFG_PULLCTL_UP);
    ...
    /* with SCL_LP==6 && SCL_HP==4 */
    /* use 0x17 for 100kHZ with 48MHZ CPU clock */
    I2C->MTPR = 0x00000017;
}
