...
ztimer_instance_t *const ZTIMER_MSEC = (ztimer_instance_t*) &_ztimer_rtt_extend;
...
void ztimer_board_init(void)
{
    ...
    ztimer_convert_init(&_ztimer_rtt_convert, (ztimer_instance_t*)&_ztimer_rtt, &ztimer_convert_ops_1000to1024);
    ztimer_extend_init(&_ztimer_rtt_extend, (ztimer_instance_t*)&_ztimer_rtt_convert, 22);
}
