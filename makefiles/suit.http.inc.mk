...
ifeq (,$(SUIT_OTA_SERVER_BASEDIR))
  $(error Please provide the path to the ota-server source base directory.)
endif

OTA_CLIENT_CMD = python3 $(SUIT_OTA_SERVER_BASEDIR)/client/otaclient.py

suit/publish: $(SUIT_MANIFESTS) $(SLOT0_RIOT_BIN) $(SLOT1_RIOT_BIN)
	$(Q)$(OTA_CLIENT_CMD) --publish-id $(SUIT_PUBLISH_ID) --publish $^
