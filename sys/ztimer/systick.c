...
/**
 * @ingroup     sys_ztimer_systick
 * @{
 *
 * @file
 * @brief       ztimer systick backend implementation
 *
...
static void _ztimer_systick_set(ztimer_clock_t *ztimer, uint32_t val)
{
    (void)ztimer;
    (void)val;
...
static uint32_t _ztimer_systick_now(ztimer_clock_t *ztimer)
{
    (void)ztimer;
...
static void _ztimer_systick_cancel(ztimer_clock_t *ztimer)
{
    (void)ztimer;
    //ztimer_systick_t *ztimer_systick = (ztimer_systick_t*) ztimer;
}
